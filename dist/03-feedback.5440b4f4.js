...
function onFormInput(e) {
    if (e.target.nodeName === "INPUT") data.email = e.target.value;
    if (e.target.nodeName === "TEXTAREA") data.message = e.target.value;
    localStorage.setItem("feedback-form-state", JSON.stringify(data));
}
function onBtnSbmt(e) {
    e.preventDefault();
    const { elements: { email , message  } ,  } = e.currentTarget;
    if (email.value === "" || message.value === "") return alert("\u0412\u0441\u0456 \u043F\u043E\u043B\u044F \u043F\u043E\u0432\u0438\u043D\u043D\u0456 \u0431\u0443\u0442\u0438 \u0437\u0430\u043F\u043E\u0432\u043D\u0435\u043D\u0456!");
    else {
        const userData = {
            email: email.value,
